...
Action.prototype.bean = function(beanname) {
    if(!this._beans[beanname]) {
        ...
        if(BeanClass) {
            ...
            console.log('New bean<'+ beanObj._classname +'> instance');
            if(autoBuild == true) {
...
Action.prototype.service = function(servicename) {
    if(!this._services[servicename]) {
        ...
        if(ServiceClass) {
            ...
            console.log('New service<'+ serviceObj._classname +'> instance');
            if(autoInit == true) {  
...
Action.prototype.template = function() {
    ...
    if(!this._template) {
        ...
        console.log('New template<'+ this._template._classname +'> instance');
...
Action.prototype.scope = function() {
    if(!this._scope) {
        ...
        console.log('New scope<'+ this._scope._classname +'> instance');
    }
    return this._scope;
};
Action.prototype.dispatch = function() {
    console.log('Into Action::dispatch()');
    var req    = this.request;
    var res    = this.response;
