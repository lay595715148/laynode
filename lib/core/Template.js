...
Template.prototype._error      = false;
...
Template.prototype.error = function(err) {
    this.push(Template.ERROR_TAG, err);
};
Template.prototype.hasError = function() {
    return (this._vars[Template.ERROR_TAG])?true:false;
};
...
Template.prototype.display = function() {
    var res = this._response;   console.log('display');
    var content = '';
